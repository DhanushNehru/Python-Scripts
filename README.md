...
|Crop_Images                   | https://github.com/nishantattrey07/Python-Scripts/tree/master/Crop_Images                  | This script will crop the given image.
| CSVToExcel                   | https://github.com/nishantattrey07/Python-Scripts/tree/master/CSVToExcel                   | Convert CSV file to Excel
| Currency Converter           | https://github.com/nishantattrey07/Python-Scripts/tree/master/currency_script              | Convert the currency to different currency
...
| Face Reaction                | https://github.com/nishantattrey07/Python-Scripts/tree/master/Face%20Reaction              | Recognize the Facila expression
...
| Image Compressor             | https://github.com/nishantattrey07/Python-Scripts/tree/master/ImageCompress                | Compresses Images
| IP-Geolocator                | https://github.com/nishantattrey07/Python-Scripts/tree/master/IP-Geolocator                | Locates the Geo Location of IP
...
| Image_Text to PDF            | https://github.com/nishantattrey07/Python-Scripts/tree/master/Image_Text%20to%20PDF        | Converts image to PDF
| Image-To-ASCII               | https://github.com/nishantattrey07/Python-Scripts/tree/master/Image-To-ASCII               | Converts image to ASCII code
| Image-To-GIF                 | https://github.com/nishantattrey07/Python-Scripts/tree/master/Image-to-gif                 | Converts image to GIF
| JSON-To-CSV                  | https://github.com/nishantattrey07/Python-Scripts/tree/master/Json_2_csv                   | Converts json to csv
...
| Keyword Retweeter bot        | https://github.com/nishantattrey07/Python-Scripts/tree/master/Keyword-retweet-twitter-bot  | This bot will search for the Keywords on twitter and then retweet the latest tweets containing it. 
| Mail Sender                  | https://github.com/nishantattrey07/Python-Scripts/tree/master/Mail%20Sender                | Automatic sends mail
| Merge-Two-Images             | https://github.com/nishantattrey07/Python-Scripts/tree/master/Merge-Two-Images             | Merges two images as required- Horizontally or Vertically.
...
| PDF-To-Audio                 | https://github.com/nishantattrey07/Python-Scripts/tree/master/PDF%20to%20Audio             | Saves PDF file to audio 
| Planet Simulation            | https://github.com/nishantattrey07/Python-Scripts/tree/master/planetSimulation             | Planet simulation game
| Remove Background            | https://github.com/nishantattrey07/Python-Scripts/tree/master/Remove%20Background          | This script removes bacckground of images.
...
| Snake-Water-Gun              | https://github.com/nishantattrey07/Python-Scripts/tree/master/Snake-Water-Gun              | Snake water gun game
...
| TCP Chat Server              | https://github.com/DhanushNehru/Python-Scripts/tree/master/TCP%20Chat%20Server             | Creates a local server on your LAN for receiving and sending messages! 
| Tic-Tac-Toe                   | https://github.com/nishantattrey07/Python-Scripts/tree/master/Tic-Tac-Toe                  | Tic-Tac-Toe game
...
| selenium-twitter-bot         | https://github.com/nishantattrey07/Python-Scripts/tree/master/Twitter-Selenium-Bot         | Selenium based solution for creating a twitter bot                                                                   
...
| Video Watermarker            | https://github.com/nishantattrey07/Python-Scripts/tree/master/Video%20Watermarker          |Add Watermark to your videos 
| Virtual Painter              | https://github.com/nishantattrey07/Python-Scripts/tree/master/Virtual_Painter              | Virtual painter 
...
| Weather Gui                  | https://github.com/nishantattrey07/Python-Scripts/tree/master/Weather%20GUI                | Weather Gui
| Website Blocker              | https://github.com/nishantattrey07/Python-Scripts/tree/master/Website%20Blocker/mac        | blocks certain distracting website
